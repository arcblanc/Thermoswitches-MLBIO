...
#   bash scripts/eva/macleod_eva_install_smoke.sh --skip-download   # reuse checkpoint
#   bash scripts/eva/macleod_eva_install_smoke.sh --repo-smoke      # also run eva_generate --smoke
#   bash scripts/eva/macleod_eva_install_smoke.sh --skip-birna      # with --repo-smoke: generate only
set -euo pipefail
...
echo "  FASTA: ${OUT_FA}"
echo "  Next: bash scripts/eva/macleod_eva_install_smoke.sh --skip-download --repo-smoke"
